  ...
  return (
    ...
    >
      <div className="flex flex-1 flex-col justify-between p-5">
        ...
        <div className="mt-3 flex items-center gap-1 font-mono text-[11px] text-paper-textSubtle group-hover:text-paper-coral transition-colors">
          <span className="truncate">{url}</span>
          <ExternalLink className="h-3 w-3 shrink-0" />
        </div>
      </div>
      {image && (
        <div className="relative h-40 sm:h-auto sm:w-48 shrink-0 overflow-hidden bg-paper-subtle border-t sm:border-t-0 sm:border-l border-paper-border">
          <img
            src={image}
            alt={title}
